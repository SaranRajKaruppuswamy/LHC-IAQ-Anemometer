...
void logSDCard() 
{
dataMessage =  timeStamp  +  String(anemometer1)+  ","  + String(anemometer2) +  "\r\n";
...
anemometer1 = 0;
anemometer2 = 0;
int analog1in = analogRead(12);
int analog2in = analogRead(14);
float voltage1 = analog1in * (3.3 / 4095.0);
float voltage2 = analog2in * (3.3 / 4095.0);
anemometer1 = (((voltage1-0)/(3-0))*50);
anemometer2 =(((voltage2-0)/(3-0))*50);


 Serial.print("   velocity1:");
 Serial.println(anemometer1);
